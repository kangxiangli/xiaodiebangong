            ...
            if ($(".swiper-slide").eq(i).hasClass('swiper-slide-active')) {
                if (i == 0) {
                    ...
                    function hgt(id, hg) {
                        ...
                        $(".pillar li i").eq(id).html(arry[id]+"k").animate({"margin-top":arry[i] * hg + th / 28 + 10},1500).show();
                    }
                    ...
                    for (var q = 0; q < arry.length; q++) {
                        var liNum = $(".pillar li i").eq(q).html().replace('k','');
                        if (arry[0] == liNum) {
                    ...
                    function addPeo(ratio) {
                        for (var k = 0; k < huiy.length; k++) {
                            ...
                            for (var t = 0; t < peo / ratio; t++) {
                                pimg = '<img src="shujimg/r.png" alt="png"/>';
                                pli += pimg;
                            }
